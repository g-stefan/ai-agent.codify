...
def append(filename: str, text: str, workspace_dir: str) -> str:
...
if __name__ == "__main__":
    ...
    parser.add_argument("filename_pos", nargs="?", help="The file to append to.")
    parser.add_argument("text_pos", nargs="?", help="The text to append.")
    parser.add_argument("--filename", help="The file to append to.")
    parser.add_argument("--text", help="The text to append.")
    ...
    result = append(filename, text, args.workspace_dir)
    print(result)
