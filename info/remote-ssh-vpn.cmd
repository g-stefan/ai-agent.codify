...
python ..\utilities\remote-ssh-vpn.py %LLM_MACHINE_ADDRESS% --port %LLM_MACHINE_PORT% %AUTH% %SERVER_MARIADB% %SERVER_LLM_MODEL% %SERVER_LLM_EMBEDDING% %SERVER_LLM_RERANK%
